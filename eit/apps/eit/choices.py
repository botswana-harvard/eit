...
INFANT_DRUG_INITIATION = (
    ...
    ('congenital anomaly',
     '2. Contra-indicated: Infant with congenital anomaly affecting probability of survival to 18 months'),
...
INFANT_PRE_RANDO_LOSS_REASON = (
    ...
    ('father decision',
     '7. Father of baby did not want mother/infant to participate and participant withdrew consent'),
    ('other family member',
...
INFANT_OFF_STUDY_REASON = (
    ...
    ('death',
     '2. Death (complete the DEATH REPORT FORM AF005) (For EAE Reporting requirements see EAE Reporting Manual)'),
    ('refused contact',
     '3. Mother of participant (or Participant\'s family) refused further contact (explain in Comments below)'),
