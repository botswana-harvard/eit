...
class EitInfantBirthVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['1000'] = {
        ...
        'requisitions': (
            ...
            RequisitionPanelTuple(250L, u'eit_lab', u'infantrequisition',
                                  'Plasma Storage', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            ...
            RequisitionPanelTuple(550L, u'eit_lab', u'infantrequisition',
                                  'BHP074 Chemistry NON-LPV', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(580L, u'eit_lab', u'infantrequisition',
                                  'BHP074 Chemistry LPV', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            ...
            RequisitionPanelTuple(910L, u'eit_lab', u'infantrequisition',
                                  'HIV Genotyping', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
        ),
        'entries': ()
    }
    ...
    visit_definitions['2040'] = {
        'title': 'Infant 204 Weeks Visit',
        'time_point': 2040,
        'base_interval': 204 * 7,
        'base_interval_unit': 'D',
        'window_lower_bound': 0,
    ...
    visit_definitions['2160'] = {
        'title': 'Infant 216 Weeks Visit',
        'time_point': 2160,
        'base_interval': 216 * 7,
        'base_interval_unit': 'D',
        'window_lower_bound': 0,
    ...
    visit_definitions['2280'] = {
        'title': 'Infant 228 Weeks Visit',
        'time_point': 2280,
        'base_interval': 228 * 7,
        'base_interval_unit': 'D',
        'window_lower_bound': 0,
