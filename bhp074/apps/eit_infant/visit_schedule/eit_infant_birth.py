...
class EitInfantBirthVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['1000'] = {
            ...
            'requisitions': (
                ...
                RequisitionPanelTuple(550L, u'eit_lab', u'infantrequisition', 'BHP074 Chemistry', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
                RequisitionPanelTuple(580L, u'eit_lab', u'infantrequisition', 'BHP074 Chemistry LPZ', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
